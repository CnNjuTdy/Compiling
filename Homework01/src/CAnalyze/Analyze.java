...
public class Analyze {
    ...
    static enum STATE{
        ...
        INEXCLAMATORY,INAND,//
        INOR,INSOLIDUS,INDIGIT,INDECIMALS,ANNOTATION_ONE_LINE,ANNOTATION_MULTI_LINE,ANNOTATION_MULTI_LINE_ASTERISK,
        SINGLE_QUOTE_MARK,DOUBLE_QUOTE_MARK
    }
    static enum TOKEN{
        KEYWORDS,//关键字
        IDENTIFIER,//标识符
    ...
    static String KEYWORDS[]={"public","class","static","void",
            "main","while","if","else","for","switch","case","package","String","int","float","double","char"};
